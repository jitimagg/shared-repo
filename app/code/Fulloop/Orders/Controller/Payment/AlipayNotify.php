...
class AlipayNotify extends \Magento\Framework\App\Action\Action implements \Magento\Framework\App\CsrfAwareActionInterface
{
...
//            $this->_log('notify'.print_r($_POST, true));
    ...
    {
        // $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/alipay_notify.log');
        // $logger = new \Zend\Log\Logger();
        // $logger->addWriter($writer);
        // $logger->info($msg);

         $this->helperData->generalLog('/var/log/alipay_notify.log', $msg);
    }
}
