...
class Topmega extends Topmenu 
{
    ...
    /**
     * @var Megnor\CategoriesUrl\Helper\Data
     */
    ...
    public function __construct(
        ...
        Registry $registry,
        \Megnor\Category\Helper\Data $dataHelper,
        array $data = []
    ) {
