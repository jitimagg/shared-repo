...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getLabelProduct($_product)
    {
        ...
        if ($showNewLabel) {
			...
			$newsFrom = !empty($_product->getData('news_from_date')) ? substr($_product->getData('news_from_date'), 0, 10) : '';
			$newsTo = !empty($_product->getData('news_to_date')) ? substr($_product->getData('news_to_date'), 0, 10) : '';
